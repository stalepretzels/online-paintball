...
async function ae(o, e = {}) {
  const {
    ...
    cdnUrl: i,
    ...r
  } = e, a = Ve(o, s, i), n = t ? localStorage : sessionStorage, l = `emojibase/${s}/${o}`, d = n.getItem(l);
  if (d)
...
class Je extends xe {
  ...
  searchEmojis(e, t, s, i) {
    const r = this.emojis.filter((l) => B(l, e, i) && l.version <= s).map(E), a = t.filter((l) => B(l, e, i)), n = [
      ...O(r, s),
      ...a
    ];
...
async function et(o, e, t) {
  const s = await Pe(o, e, t), [i, r] = await Ye(o);
...
async function tt(o, e, t, s, i) {
  const r = await Pe(o, e, i), a = await Ke(s);
...
class u {
  constructor(e, t = {}) {
    ...
    f(this, b, void 0);
    f(this, x, void 0);
    A(this, b, e), A(this, x, t.mode || Ct.mode);
  }
  renderSync(e = {}) {
    const t = Q(y(this, b).call(this, e));
    return g(this, z, te).call(this, t, e), g(this, P, ee).call(this, t), g(this, S, X).call(this, t, e), t;
  }
  async renderAsync(e = {}) {
    const t = Q(y(this, b).call(this, e));
    return g(this, z, te).call(this, t, e), g(this, P, ee).call(this, t), await g(this, S, X).call(this, t, e), t;
  }
  render(e) {
    return y(this, x) === "sync" ? this.renderSync(e) : this.renderAsync(e);
  }
}
b = new WeakMap(), x = new WeakMap(), S = new WeakSet(), X = async function(e, t) {
...
}, P = new WeakSet(), ee = function(e) {
  e.querySelectorAll("i[data-icon]").forEach((s) => {
    const { icon: i, size: r } = s.dataset;
    s.replaceWith(ze(i, r));
  });
}, z = new WeakSet(), te = function(e, t) {
...
class xt {
  ...
  renderCustom(e, t, s = "") {
    const i = [Et.customEmoji, s].join(" ").trim(), { content: r, resolver: a } = this.renderImage(i, () => e.url), n = r instanceof Element ? r : r.el;
    return a && a(), n;
  }
}
const St = new u(({ emoji: o }) => (
  /* html */
  `<span>${o}</span>`
));
class Pt extends xt {
  ...
  async searchEmojis(e, t, s, i) {
    ...
    return new Promise((a, n) => {
      ...
      m.addEventListener("success", (h) => {
        ...
        const K = H.value;
        B(K, e, i) && K.version <= s && r.push(E(K)), H.continue();
...
function $t(o = {}) {
  return {
    ...Lt,
    ...o,
    renderer: o.renderer || new Pt(),
    recentsProvider: o.recentsProvider || new Ft()
  };
}
var v, C, D, F, se;
class le {
  ...
  on(e, t, s) {
    g(this, F, se).call(this, e, t, s);
  }
  once(e, t, s) {
    g(this, F, se).call(this, e, t, s, !0);
  }
  off(e, t) {
...
}, F = new WeakSet(), se = function(e, t, s, i = !1) {
...
class co extends c {
  ...
  async render() {
    return await super.render(), this.searchIcon = ze("search"), this.notFoundMessage = this.viewFactory.create(re, {
