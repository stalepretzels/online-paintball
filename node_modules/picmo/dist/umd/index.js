(function(n,m){typeof exports=="object"&&typeof module<"u"?m(exports):typeof define=="function"&&define.amd?define(["exports"],m):(n=typeof globalThis<"u"?globalThis:n||self,m(n.picmo={}))})(this,function(n){var k,A,I,ye,T,fe,R,ve,C,E,Z,M,we,V;"use strict";var ge=(n,m,f)=>{if(!m.has(n))throw TypeError("Cannot "+f)};var w=(n,m,f)=>(ge(n,m,"read from private field"),f?f.call(n):m.get(n)),b=(n,m,f)=>{if(m.has(n))throw TypeError("Cannot add the same private member more than once");m instanceof WeakSet?m.add(n):m.set(n,f)},J=(n,m,f,_)=>(ge(n,m,"write to private field"),_?_.call(n,f):m.set(n,f),f);var v=(n,m,f)=>(ge(n,m,"access private method"),f);const m="14.0";function f(i,e,t){let o=`https://cdn.jsdelivr.net/npm/emojibase-data@${e}/${i}`;return typeof t=="function"?o=t(i,e):typeof t=="string"&&(o=`${t}/${i}`),o}async function _(i,e={}){const{local:t=!1,version:o="latest",cdnUrl:s,...r}=e,a=f(i,o,s),c=t?localStorage:sessionStorage,h=`emojibase/${o}/${i}`,u=c.getItem(h);if(u)return Promise.resolve(JSON.parse(u));const g=await fetch(a,{credentials:"omit",mode:"cors",redirect:"error",...r});if(!g.ok)throw new Error("Failed to load Emojibase dataset.");const d=await g.json();try{c.setItem(h,JSON.stringify(d))}catch{}return d}const Xe={discord:"joypixels",slack:"iamcal"};async function be(i,e,t){var o;return _(`${i}/shortcodes/${(o=Xe[e])!==null&&o!==void 0?o:e}.json`,t)}function S(i,e){if(e.length===0)return i;const t=new Set(i.shortcodes);return e.forEach(o=>{const s=o[i.hexcode];Array.isArray(s)?s.forEach(r=>t.add(r)):s&&t.add(s)}),i.shortcodes=[...t],i.skins&&i.skins.forEach(o=>{S(o,e)}),i}function et(i,e=[]){const t=[];return i.forEach(o=>{if(o.skins){const{skins:s,...r}=o;t.push(S(r,e)),s.forEach(a=>{const c={...a};r.tags&&(c.tags=[...r.tags]),t.push(S(c,e))})}else t.push(S(o,e))}),t}function tt(i,e){return e.length===0||i.forEach(t=>{S(t,e)}),i}async function Ce(i,e={}){const{compact:t=!1,flat:o=!1,shortcodes:s=[],...r}=e,a=await _(`${i}/${t?"compact":"data"}.json`,r);let c=[];return s.length>0&&(c=await Promise.all(s.map(h=>{let u;if(h.includes("/")){const[g,d]=h.split("/");u=be(g,d,r)}else u=be(i,h,r);return u.catch(()=>({}))}))),o?et(a,c):tt(a,c)}async function je(i,e){return _(`${i}/messages.json`,e)}function D(i,e){const o=i.target.closest("[data-emoji]");if(o){const s=e.find(r=>r.emoji===o.dataset.emoji);if(s)return s}return null}function Y(i){var t;const e=(t=window.matchMedia)==null?void 0:t.call(window,"(prefers-reduced-motion: reduce)");return i.animate&&!(e!=null&&e.matches)}function Q(i,e){return i.toLowerCase().includes(e.toLowerCase())}function _e(i,e){let t=null;return()=>{t||(t=window.setTimeout(()=>{i(),t=null},e))}}function ke(i,e){let t=null;return(...o)=>{t&&window.clearTimeout(t),t=window.setTimeout(()=>{i(...o),t=null},e)}}function x(i,e,t,o){if(Y(o)&&i.animate)return i.animate(e,t).finished;const s=t.direction==="normal"?1:0,r=Object.entries(e).reduce((a,[c,h])=>({...a,[c]:h[s]}),{});return Object.assign(i.style,r),Promise.resolve()}function B(i){var t;const e=document.createElement("template");return e.innerHTML=i,(t=e.content)==null?void 0:t.firstElementChild}async function Ee(i){const e=new TextEncoder().encode(i),t=await crypto.subtle.digest("SHA-256",e);return Array.from(new Uint8Array(t)).map(s=>s.toString(16).padStart(2,"0")).join("")}function y(...i){return i.reduce((e,t)=>({...e,[t]:N(t)}),{})}function N(i){return`picmo__${i}`}function P(i){for(;i.firstChild;)i.removeChild(i.firstChild);return i}function j(i,...e){P(i).append(...e)}function Se(i){try{return window[i].length,!0}catch{return!1}}function xe(){return Se("sessionStorage")}function Pe(){return Se("localStorage")}function ze(){let i={};return{getItem:e=>i[e],setItem:(e,t)=>i[e]=t,length:Object.keys(i).length,clear:()=>i={},key:e=>Object.keys(i)[e],removeItem:e=>delete i[e]}}function z(i){var e;return{emoji:i.emoji,label:i.label,tags:i.tags,skins:(e=i.skins)==null?void 0:e.map(t=>z(t)),order:i.order,custom:!1,hexcode:i.hexcode,version:i.version}}function O(i,e,t){var o;return t&&!t.some(s=>s.order===i.group)?!1:Q(i.label,e)||((o=i.tags)==null?void 0:o.some(s=>Q(s,e)))}class Fe{constructor(e="en"){this.locale=e}}const it=[(i,e)=>(i.hexcode==="1F91D"&&e<14&&(i.skins=[]),i),(i,e)=>(i.skins&&(i.skins=i.skins.filter(t=>!t.version||t.version<=e)),i)];function ot(i,e){return it.some(t=>t(i,e)===null)?null:i}function H(i,e){return i.filter(t=>ot(t,e)!==null)}const X={};function ee(i){return X[i]||(X[i]=new st(i)),X[i]}ee.deleteDatabase=i=>{};class st extends Fe{open(){return Promise.resolve()}delete(){return Promise.resolve()}close(){}isPopulated(){return Promise.resolve(!1)}getEmojiCount(){return Promise.resolve(this.emojis.length)}getEtags(){return Promise.resolve({foo:"bar"})}getHash(){return Promise.resolve("")}populate(e){return this.categories=e.groups,this.emojis=e.emojis,Promise.resolve()}getCategories(e){var o;let t=this.categories.filter(s=>s.key!=="component");if(e.showRecents&&t.unshift({key:"recents",order:-1}),(o=e.custom)!=null&&o.length&&t.push({key:"custom",order:10}),e.categories){const s=e.categories;t=t.filter(r=>s.includes(r.key)),t.sort((r,a)=>s.indexOf(r.key)-s.indexOf(a.key))}else t.sort((s,r)=>s.order-r.order);return Promise.resolve(t)}getEmojis(e,t){const o=this.emojis.filter(s=>s.group===e.order).filter(s=>s.version<=t).sort((s,r)=>s.order!=null&&r.order!=null?s.order-r.order:0).map(z);return Promise.resolve(H(o,t))}searchEmojis(e,t,o,s){const r=this.emojis.filter(h=>O(h,e,s)&&h.version<=o).map(z),a=t.filter(h=>O(h,e,s)),c=[...H(r,o),...a];return Promise.resolve(c)}setMeta(e){this.meta=e}}!xe()&&typeof window<"u"&&(console.warn("[picmo] sessionStorage not available, falling back to simple in-memory storage"),Object.defineProperty(window,"sessionStorage",{value:ze()}));function rt(i,e){const t=`https://cdn.jsdelivr.net/npm/emojibase-data@${i}/${e}`;return{emojisUrl:`${t}/data.json`,messagesUrl:`${t}/messages.json`}}async function Le(i){try{return(await fetch(i,{method:"HEAD"})).headers.get("etag")}catch{return null}}function at(i){const{emojisUrl:e,messagesUrl:t}=rt("latest",i);try{return Promise.all([Le(e),Le(t)])}catch{return Promise.all([null,null])}}async function nt(i,e,t){let o;try{o=await i.getEtags()}catch{o={}}const{storedEmojisEtag:s,storedMessagesEtag:r}=o;if(t!==r||e!==s){const[a,c]=await Promise.all([je(i.locale),Ce(i.locale)]);await i.populate({groups:a.groups,emojis:c,emojisEtag:e,messagesEtag:t})}}async function ct(i,e){const t=await i.getHash();return e!==t}async function $e(i,e,t){let o=t||e(i);try{await o.open()}catch{console.warn("[picmo] IndexedDB not available, falling back to InMemoryStoreFactory"),o=ee(i)}return o}async function lt(i,e,t){const o=await $e(i,e,t),[s,r]=await at(i);if(await o.isPopulated())s&&r&&await nt(o,s,r);else{const[a,c]=await Promise.all([je(i),Ce(i)]);await o.populate({groups:a.groups,emojis:c,emojisEtag:s,messagesEtag:r})}return o}async function ht(i,e,t,o,s){const r=await $e(i,e,s),a=await Ee(o);return(!await r.isPopulated()||await ct(r,a))&&await r.populate({groups:t.groups,emojis:o,hash:a}),r}async function te(i,e,t,o,s){return t&&o?ht(i,e,t,o,s):lt(i,e,s)}function dt(i,e){i.deleteDatabase(e)}class Ae{constructor(){this.handleKeyDown=this.handleKeyDown.bind(this)}activate(e){this.rootElement=e,this.rootElement.addEventListener("keydown",this.handleKeyDown)}deactivate(){var e;(e=this.rootElement)==null||e.removeEventListener("keydown",this.handleKeyDown)}get focusableElements(){return this.rootElement.querySelectorAll('input, [tabindex="0"]')}get lastFocusableElement(){return this.focusableElements[this.focusableElements.length-1]}get firstFocusableElement(){return this.focusableElements[0]}checkFocus(e,t,o){e.target===t&&(o.focus(),e.preventDefault())}handleKeyDown(e){e.key==="Tab"&&this.checkFocus(e,e.shiftKey?this.firstFocusableElement:this.lastFocusableElement,e.shiftKey?this.lastFocusableElement:this.firstFocusableElement)}}const{light:Ie,dark:mt,auto:ut}=y("light","dark","auto");class l{constructor({template:e,classes:t,parent:o}){this.isDestroyed=!1,this.appEvents={},this.uiEvents=[],this.uiElements={},this.ui={},this.template=e,this.classes=t,this.parent=o,this.keyBindingHandler=this.keyBindingHandler.bind(this)}initialize(){this.bindAppEvents()}setCustomEmojis(e){this.customEmojis=e}setEvents(e){this.events=e}setPickerId(e){this.pickerId=e}emit(e,...t){this.events.emit(e,...t)}setI18n(e){this.i18n=e}setRenderer(e){this.renderer=e}setEmojiData(e){this.emojiDataPromise=e,e.then(t=>{this.emojiData=t})}updateEmojiData(e){this.emojiData=e,this.emojiDataPromise=Promise.resolve(e)}setOptions(e){this.options=e}renderSync(e={}){return this.el=this.template.renderSync({classes:this.classes,i18n:this.i18n,pickerId:this.pickerId,...e}),this.postRender(),this.el}async render(e={}){return await this.emojiDataPromise,this.el=await this.template.renderAsync({classes:this.classes,i18n:this.i18n,pickerId:this.pickerId,...e}),this.postRender(),this.el}postRender(){this.bindUIElements(),this.bindKeyBindings(),this.bindUIEvents(),this.scheduleShowAnimation()}bindAppEvents(){Object.keys(this.appEvents).forEach(e=>{this.events.on(e,this.appEvents[e],this)}),this.events.on("data:ready",this.updateEmojiData,this)}unbindAppEvents(){Object.keys(this.appEvents).forEach(e=>{this.events.off(e,this.appEvents[e])}),this.events.off("data:ready",this.updateEmojiData)}keyBindingHandler(e){const t=this.keyBindings[e.key];t&&t.call(this,e)}bindKeyBindings(){this.keyBindings&&this.el.addEventListener("keydown",this.keyBindingHandler)}unbindKeyBindings(){this.keyBindings&&this.el.removeEventListener("keydown",this.keyBindingHandler)}bindUIElements(){this.ui=Object.keys(this.uiElements).reduce((e,t)=>({...e,[t]:this.el.querySelector(this.uiElements[t])}),{})}bindUIEvents(){this.uiEvents.forEach(e=>{e.handler=e.handler.bind(this),(e.target?this.ui[e.target]:this.el).addEventListener(e.event,e.handler,e.options)})}unbindUIEvents(){this.uiEvents.forEach(e=>{(e.target?this.ui[e.target]:this.el).removeEventListener(e.event,e.handler)})}destroy(){this.unbindAppEvents(),this.unbindUIEvents(),this.unbindKeyBindings(),this.el.remove(),this.isDestroyed=!0}scheduleShowAnimation(){if(this.parent){const e=new MutationObserver(t=>{const[o]=t;o.type==="childList"&&o.addedNodes[0]===this.el&&(Y(this.options)&&this.animateShow&&this.animateShow(),e.disconnect)});e.observe(this.parent,{childList:!0})}}static childEvent(e,t,o,s={}){return{target:e,event:t,handler:o,options:s}}static uiEvent(e,t,o={}){return{event:e,handler:t,options:o}}static byClass(e){return`.${e}`}}const pt='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256C512 397.4 397.4 512 256 512zM232 256C232 264 236 271.5 242.7 275.1L338.7 339.1C349.7 347.3 364.6 344.3 371.1 333.3C379.3 322.3 376.3 307.4 365.3 300L280 243.2V120C280 106.7 269.3 96 255.1 96C242.7 96 231.1 106.7 231.1 120L232 256z"/></svg>',gt='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M64 496C64 504.8 56.75 512 48 512h-32C7.25 512 0 504.8 0 496V32c0-17.75 14.25-32 32-32s32 14.25 32 32V496zM476.3 0c-6.365 0-13.01 1.35-19.34 4.233c-45.69 20.86-79.56 27.94-107.8 27.94c-59.96 0-94.81-31.86-163.9-31.87C160.9 .3055 131.6 4.867 96 15.75v350.5c32-9.984 59.87-14.1 84.85-14.1c73.63 0 124.9 31.78 198.6 31.78c31.91 0 68.02-5.971 111.1-23.09C504.1 355.9 512 344.4 512 332.1V30.73C512 11.1 495.3 0 476.3 0z"/></svg>',yt='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256zM176.4 240C194 240 208.4 225.7 208.4 208C208.4 190.3 194 176 176.4 176C158.7 176 144.4 190.3 144.4 208C144.4 225.7 158.7 240 176.4 240zM336.4 176C318.7 176 304.4 190.3 304.4 208C304.4 225.7 318.7 240 336.4 240C354 240 368.4 225.7 368.4 208C368.4 190.3 354 176 336.4 176zM259.9 369.4C288.8 369.4 316.2 375.2 340.6 385.5C352.9 390.7 366.7 381.3 361.4 369.1C344.8 330.9 305.6 303.1 259.9 303.1C214.3 303.1 175.1 330.8 158.4 369.1C153.1 381.3 166.1 390.6 179.3 385.4C203.7 375.1 231 369.4 259.9 369.4L259.9 369.4z"/></svg>',ft='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M448 64H192C85.96 64 0 149.1 0 256s85.96 192 192 192h256c106 0 192-85.96 192-192S554 64 448 64zM247.1 280h-32v32c0 13.2-10.78 24-23.98 24c-13.2 0-24.02-10.8-24.02-24v-32L136 279.1C122.8 279.1 111.1 269.2 111.1 256c0-13.2 10.85-24.01 24.05-24.01L167.1 232v-32c0-13.2 10.82-24 24.02-24c13.2 0 23.98 10.8 23.98 24v32h32c13.2 0 24.02 10.8 24.02 24C271.1 269.2 261.2 280 247.1 280zM431.1 344c-22.12 0-39.1-17.87-39.1-39.1s17.87-40 39.1-40s39.1 17.88 39.1 40S454.1 344 431.1 344zM495.1 248c-22.12 0-39.1-17.87-39.1-39.1s17.87-40 39.1-40c22.12 0 39.1 17.88 39.1 40S518.1 248 495.1 248z"/></svg>',vt='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M112.1 454.3c0 6.297 1.816 12.44 5.284 17.69l17.14 25.69c5.25 7.875 17.17 14.28 26.64 14.28h61.67c9.438 0 21.36-6.401 26.61-14.28l17.08-25.68c2.938-4.438 5.348-12.37 5.348-17.7L272 415.1h-160L112.1 454.3zM191.4 .0132C89.44 .3257 16 82.97 16 175.1c0 44.38 16.44 84.84 43.56 115.8c16.53 18.84 42.34 58.23 52.22 91.45c.0313 .25 .0938 .5166 .125 .7823h160.2c.0313-.2656 .0938-.5166 .125-.7823c9.875-33.22 35.69-72.61 52.22-91.45C351.6 260.8 368 220.4 368 175.1C368 78.61 288.9-.2837 191.4 .0132zM192 96.01c-44.13 0-80 35.89-80 79.1C112 184.8 104.8 192 96 192S80 184.8 80 176c0-61.76 50.25-111.1 112-111.1c8.844 0 16 7.159 16 16S200.8 96.01 192 96.01z"/></svg>',wt='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M512 32H120c-13.25 0-24 10.75-24 24L96.01 288c0 53 43 96 96 96h192C437 384 480 341 480 288h32c70.63 0 128-57.38 128-128S582.6 32 512 32zM512 224h-32V96h32c35.25 0 64 28.75 64 64S547.3 224 512 224zM560 416h-544C7.164 416 0 423.2 0 432C0 458.5 21.49 480 48 480h480c26.51 0 48-21.49 48-48C576 423.2 568.8 416 560 416z"/></svg>',bt='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M482.3 192C516.5 192 576 221 576 256C576 292 516.5 320 482.3 320H365.7L265.2 495.9C259.5 505.8 248.9 512 237.4 512H181.2C170.6 512 162.9 501.8 165.8 491.6L214.9 320H112L68.8 377.6C65.78 381.6 61.04 384 56 384H14.03C6.284 384 0 377.7 0 369.1C0 368.7 .1818 367.4 .5398 366.1L32 256L.5398 145.9C.1818 144.6 0 143.3 0 142C0 134.3 6.284 128 14.03 128H56C61.04 128 65.78 130.4 68.8 134.4L112 192H214.9L165.8 20.4C162.9 10.17 170.6 0 181.2 0H237.4C248.9 0 259.5 6.153 265.2 16.12L365.7 192H482.3z"/></svg>',Ct='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M9.375 233.4C3.375 239.4 0 247.5 0 256v128c0 8.5 3.375 16.62 9.375 22.62S23.5 416 32 416h32V224H32C23.5 224 15.38 227.4 9.375 233.4zM464 96H352V32c0-17.62-14.38-32-32-32S288 14.38 288 32v64H176C131.8 96 96 131.8 96 176V448c0 35.38 28.62 64 64 64h320c35.38 0 64-28.62 64-64V176C544 131.8 508.3 96 464 96zM256 416H192v-32h64V416zM224 296C201.9 296 184 278.1 184 256S201.9 216 224 216S264 233.9 264 256S246.1 296 224 296zM352 416H288v-32h64V416zM448 416h-64v-32h64V416zM416 296c-22.12 0-40-17.88-40-40S393.9 216 416 216S456 233.9 456 256S438.1 296 416 296zM630.6 233.4C624.6 227.4 616.5 224 608 224h-32v192h32c8.5 0 16.62-3.375 22.62-9.375S640 392.5 640 384V256C640 247.5 636.6 239.4 630.6 233.4z"/></svg>',jt=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  <defs>
...
</svg>`,_t='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M500.3 443.7l-119.7-119.7c27.22-40.41 40.65-90.9 33.46-144.7C401.8 87.79 326.8 13.32 235.2 1.723C99.01-15.51-15.51 99.01 1.724 235.2c11.6 91.64 86.08 166.7 177.6 178.9c53.8 7.189 104.3-6.236 144.7-33.46l119.7 119.7c15.62 15.62 40.95 15.62 56.57 0C515.9 484.7 515.9 459.3 500.3 443.7zM79.1 208c0-70.58 57.42-128 128-128s128 57.42 128 128c0 70.58-57.42 128-128 128S79.1 278.6 79.1 208z"/></svg>',kt='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256zM256.3 331.8C208.9 331.8 164.1 324.9 124.5 312.8C112.2 309 100.2 319.7 105.2 331.5C130.1 390.6 188.4 432 256.3 432C324.2 432 382.4 390.6 407.4 331.5C412.4 319.7 400.4 309 388.1 312.8C348.4 324.9 303.7 331.8 256.3 331.8H256.3zM176.4 176C158.7 176 144.4 190.3 144.4 208C144.4 225.7 158.7 240 176.4 240C194 240 208.4 225.7 208.4 208C208.4 190.3 194 176 176.4 176zM336.4 240C354 240 368.4 225.7 368.4 208C368.4 190.3 354 176 336.4 176C318.7 176 304.4 190.3 304.4 208C304.4 225.7 318.7 240 336.4 240z"/></svg>',Et='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M500.3 7.251C507.7 13.33 512 22.41 512 31.1V175.1C512 202.5 483.3 223.1 447.1 223.1C412.7 223.1 383.1 202.5 383.1 175.1C383.1 149.5 412.7 127.1 447.1 127.1V71.03L351.1 90.23V207.1C351.1 234.5 323.3 255.1 287.1 255.1C252.7 255.1 223.1 234.5 223.1 207.1C223.1 181.5 252.7 159.1 287.1 159.1V63.1C287.1 48.74 298.8 35.61 313.7 32.62L473.7 .6198C483.1-1.261 492.9 1.173 500.3 7.251H500.3zM74.66 303.1L86.5 286.2C92.43 277.3 102.4 271.1 113.1 271.1H174.9C185.6 271.1 195.6 277.3 201.5 286.2L213.3 303.1H239.1C266.5 303.1 287.1 325.5 287.1 351.1V463.1C287.1 490.5 266.5 511.1 239.1 511.1H47.1C21.49 511.1-.0019 490.5-.0019 463.1V351.1C-.0019 325.5 21.49 303.1 47.1 303.1H74.66zM143.1 359.1C117.5 359.1 95.1 381.5 95.1 407.1C95.1 434.5 117.5 455.1 143.1 455.1C170.5 455.1 191.1 434.5 191.1 407.1C191.1 381.5 170.5 359.1 143.1 359.1zM440.3 367.1H496C502.7 367.1 508.6 372.1 510.1 378.4C513.3 384.6 511.6 391.7 506.5 396L378.5 508C372.9 512.1 364.6 513.3 358.6 508.9C352.6 504.6 350.3 496.6 353.3 489.7L391.7 399.1H336C329.3 399.1 323.4 395.9 321 389.6C318.7 383.4 320.4 376.3 325.5 371.1L453.5 259.1C459.1 255 467.4 254.7 473.4 259.1C479.4 263.4 481.6 271.4 478.7 278.3L440.3 367.1zM116.7 219.1L19.85 119.2C-8.112 90.26-6.614 42.31 24.85 15.34C51.82-8.137 93.26-3.642 118.2 21.83L128.2 32.32L137.7 21.83C162.7-3.642 203.6-8.137 231.6 15.34C262.6 42.31 264.1 90.26 236.1 119.2L139.7 219.1C133.2 225.6 122.7 225.6 116.7 219.1H116.7z"/></svg>',St='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M413.8 447.1L256 448l0 31.99C256 497.7 241.8 512 224.1 512c-17.67 0-32.1-14.32-32.1-31.99l0-31.99l-158.9-.0099c-28.5 0-43.69-34.49-24.69-56.4l68.98-79.59H62.22c-25.41 0-39.15-29.8-22.67-49.13l60.41-70.85H89.21c-21.28 0-32.87-22.5-19.28-37.31l134.8-146.5c10.4-11.3 28.22-11.3 38.62-.0033l134.9 146.5c13.62 14.81 2.001 37.31-19.28 37.31h-10.77l60.35 70.86c16.46 19.34 2.716 49.12-22.68 49.12h-15.2l68.98 79.59C458.7 413.7 443.1 447.1 413.8 447.1z"/></svg>',xt='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M224 256c70.7 0 128-57.31 128-128S294.7 0 224 0C153.3 0 96 57.31 96 128S153.3 256 224 256zM274.7 304H173.3c-95.73 0-173.3 77.6-173.3 173.3C0 496.5 15.52 512 34.66 512H413.3C432.5 512 448 496.5 448 477.3C448 381.6 370.4 304 274.7 304zM479.1 320h-73.85C451.2 357.7 480 414.1 480 477.3C480 490.1 476.2 501.9 470 512h138C625.7 512 640 497.6 640 479.1C640 391.6 568.4 320 479.1 320zM432 256C493.9 256 544 205.9 544 144S493.9 32 432 32c-25.11 0-48.04 8.555-66.72 22.51C376.8 76.63 384 101.4 384 128c0 35.52-11.93 68.14-31.59 94.71C372.7 243.2 400.8 256 432 256z"/></svg>',Pt=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  <defs>
...
</svg>`,zt='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M310.6 361.4c12.5 12.5 12.5 32.75 0 45.25C304.4 412.9 296.2 416 288 416s-16.38-3.125-22.62-9.375L160 301.3L54.63 406.6C48.38 412.9 40.19 416 32 416S15.63 412.9 9.375 406.6c-12.5-12.5-12.5-32.75 0-45.25l105.4-105.4L9.375 150.6c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L160 210.8l105.4-105.4c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25l-105.4 105.4L310.6 361.4z"/></svg>';function Ft(i,e){const t=B(e);return t.dataset.icon=i,t.classList.add(N("icon")),t}const Te={clock:pt,flag:gt,frown:yt,gamepad:ft,lightbulb:vt,mug:wt,plane:bt,robot:Ct,sad:jt,search:_t,smiley:kt,symbols:Et,tree:St,users:xt,warning:Pt,xmark:zt},K={recents:"clock","smileys-emotion":"smiley","people-body":"users","animals-nature":"tree","food-drink":"mug",activities:"gamepad","travel-places":"plane",objects:"lightbulb",symbols:"symbols",flags:"flag",custom:"robot"};function Re(i,e){if(!(i in Te))return console.warn(`Unknown icon: "${i}"`),document.createElement("div");const t=Ft(i,Te[i]);return e&&t.classList.add(N(`icon-${e}`)),t}const Lt={mode:"sync"};class p{constructor(e,t={}){b(this,I);b(this,T);b(this,R);b(this,k,void 0);b(this,A,void 0);J(this,k,e),J(this,A,t.mode||Lt.mode)}renderSync(e={}){const t=B(w(this,k).call(this,e));return v(this,R,ve).call(this,t,e),v(this,T,fe).call(this,t),v(this,I,ye).call(this,t,e),t}async renderAsync(e={}){const t=B(w(this,k).call(this,e));return v(this,R,ve).call(this,t,e),v(this,T,fe).call(this,t),await v(this,I,ye).call(this,t,e),t}render(e){return w(this,A)==="sync"?this.renderSync(e):this.renderAsync(e)}}k=new WeakMap,A=new WeakMap,I=new WeakSet,ye=async function(e,t){const o=e.querySelectorAll("[data-view]"),s=[];for(const r of o){const a=t[r.dataset.view];a?r.dataset.render!=="sync"?s.push(a.render().then(c=>(r.replaceWith(c),c))):r.replaceWith(a.renderSync()):r.remove()}return Promise.all(s)},T=new WeakSet,fe=function(e){e.querySelectorAll("i[data-icon]").forEach(o=>{const{icon:s,size:r}=o.dataset;o.replaceWith(Re(s,r))})},R=new WeakSet,ve=function(e,t){return e.querySelectorAll("[data-placeholder]").forEach(s=>{const r=s.dataset.placeholder;if(r&&t[r]){const a=t[r];s.replaceWith(...[a].flat())}else console.warn(`Missing placeholder element for key "${r}"`)}),e};const $t=y("imagePlaceholder","placeholder"),At=new p(({classes:i})=>`
  <div class="${i.placeholder} ${i.imagePlaceholder}"></div>
`);class It extends l{constructor({classNames:e}={}){super({template:At,classes:$t}),this.classNames=e}load(e){const t=document.createElement("img");this.classNames&&(t.className=this.classNames),t.addEventListener("load",()=>{this.el.replaceWith(t)},{once:!0}),Promise.resolve(e).then(o=>t.src=o)}renderSync(){return super.renderSync(),this.classNames&&this.classNames.split(" ").forEach(t=>this.el.classList.add(t)),this.el}}const Tt=y("customEmoji");class Me{renderElement(e){return{content:e}}renderImage(e="",t){const o=new It({classNames:e});return o.renderSync(),{content:o,resolver:()=>(o.load(t()),o.el)}}doRender(e,t,o){if(e.custom)return this.renderCustom(e,t,o);const{content:s,resolver:r}=this.render(e,o),a=s instanceof Element?s:s.el;return r&&r(),a}doEmit(e){return e.custom?this.emitCustom(e):this.emit(e)}emitCustom({url:e,label:t,emoji:o,data:s}){return{url:e,label:t,emoji:o,data:s}}renderCustom(e,t,o=""){const s=[Tt.customEmoji,o].join(" ").trim(),{content:r,resolver:a}=this.renderImage(s,()=>e.url),c=r instanceof Element?r:r.el;return a&&a(),c}}const Rt=new p(({emoji:i})=>`<span>${i}</span>`);class Ve extends Me{render(e){return this.renderElement(Rt.renderSync({emoji:e.emoji}))}emit({emoji:e,hexcode:t,label:o}){return{emoji:e,hexcode:t,label:o}}}const ie={"categories.activities":"Activities","categories.animals-nature":"Animals & Nature","categories.custom":"Custom","categories.flags":"Flags","categories.food-drink":"Food & Drink","categories.objects":"Objects","categories.people-body":"People & Body","categories.recents":"Recently Used","categories.smileys-emotion":"Smileys & Emotion","categories.symbols":"Symbols","categories.travel-places":"Travel & Places","error.load":"Failed to load emojis","recents.clear":"Clear recent emojis","recents.none":"You haven't selected any emojis yet.",retry:"Try again","search.clear":"Clear search","search.error":"Failed to search emojis","search.notFound":"No results found",search:"Search emojis..."},oe="PicMo";function se(i){return new Mt(i)}se.deleteDatabase=i=>new Promise((e,t)=>{const o=indexedDB.deleteDatabase(`${oe}-${i}`);o.addEventListener("success",e),o.addEventListener("error",t)});class Mt extends Fe{async open(){const e=indexedDB.open(`${oe}-${this.locale}`);return new Promise((t,o)=>{e.addEventListener("success",s=>{var r;this.db=(r=s.target)==null?void 0:r.result,t()}),e.addEventListener("error",o),e.addEventListener("upgradeneeded",async s=>{var a;this.db=(a=s.target)==null?void 0:a.result,this.db.createObjectStore("category",{keyPath:"order"});const r=this.db.createObjectStore("emoji",{keyPath:"emoji"});r.createIndex("category","group"),r.createIndex("version","version"),this.db.createObjectStore("meta")})})}async delete(){this.close();const e=indexedDB.deleteDatabase(`${oe}-${this.locale}`);await this.waitForRequest(e)}close(){this.db.close()}async getEmojiCount(){const t=this.db.transaction("emoji","readonly").objectStore("emoji");return(await this.waitForRequest(t.count())).target.result}async getEtags(){const t=this.db.transaction("meta","readonly").objectStore("meta"),[o,s]=await Promise.all([this.waitForRequest(t.get("emojisEtag")),this.waitForRequest(t.get("messagesEtag"))]);return{storedEmojisEtag:o.target.result,storedMessagesEtag:s.target.result}}async setMeta(e){const t=this.db.transaction("meta","readwrite"),o=t.objectStore("meta");return new Promise(s=>{t.oncomplete=s,Object.keys(e).filter(Boolean).forEach(a=>{o.put(e[a],a)})})}async getHash(){const t=this.db.transaction("meta","readonly").objectStore("meta");return(await this.waitForRequest(t.get("hash"))).target.result}async isPopulated(){const t=this.db.transaction("category","readonly").objectStore("category");return(await this.waitForRequest(t.count())).target.result>0}async populate({groups:e,emojis:t,emojisEtag:o,messagesEtag:s,hash:r}){await this.removeAllObjects("category","emoji");const a=[this.addObjects("category",e),this.addObjects("emoji",t),this.setMeta({emojisEtag:o,messagesEtag:s,hash:r})];await Promise.all(a)}async getCategories(e){var a;const o=this.db.transaction("category","readonly").objectStore("category");let r=(await this.waitForRequest(o.getAll())).target.result.filter(c=>c.key!=="component");if(e.showRecents&&r.unshift({key:"recents",order:-1}),(a=e.custom)!=null&&a.length&&r.push({key:"custom",order:10}),e.categories){const c=e.categories;r=r.filter(h=>c.includes(h.key)),r.sort((h,u)=>c.indexOf(h.key)-c.indexOf(u.key))}else r.sort((c,h)=>c.order-h.order);return r}async getEmojis(e,t){const r=this.db.transaction("emoji","readonly").objectStore("emoji").index("category"),h=(await this.waitForRequest(r.getAll(e.order))).target.result.filter(u=>u.version<=t).sort((u,g)=>u.order!=null&&g.order!=null?u.order-g.order:0).map(z);return H(h,t)}async searchEmojis(e,t,o,s){const r=[];return new Promise((a,c)=>{const g=this.db.transaction("emoji","readonly").objectStore("emoji").openCursor();g.addEventListener("success",d=>{var Qe;const ue=(Qe=d.target)==null?void 0:Qe.result;if(!ue)return a([...H(r,o),...t.filter(Ni=>O(Ni,e))]);const pe=ue.value;O(pe,e,s)&&pe.version<=o&&r.push(z(pe)),ue.continue()}),g.addEventListener("error",d=>{c(d)})})}async waitForRequest(e){return new Promise((t,o)=>{e.onsuccess=t,e.onerror=o})}withTransaction(e,t="readwrite",o){return new Promise((s,r)=>{const a=this.db.transaction(e,t);a.oncomplete=s,a.onerror=r,o(a)})}async removeAllObjects(...e){const t=this.db.transaction(e,"readwrite"),o=e.map(s=>t.objectStore(s));await Promise.all(o.map(s=>this.waitForRequest(s.clear())))}async addObjects(e,t){return this.withTransaction(e,"readwrite",o=>{const s=o.objectStore(e);t.forEach(r=>{s.add(r)})})}}class re{}const ae="PicMo:recents";class De extends re{constructor(e){super(),this.storage=e}clear(){this.storage.removeItem(ae)}getRecents(e){try{return JSON.parse(this.storage.getItem(ae)??"[]").slice(0,e)}catch{return[]}}addOrUpdateRecent(e,t){const o=[e,...this.getRecents(t).filter(s=>s.hexcode!==e.hexcode)].slice(0,t);try{this.storage.setItem(ae,JSON.stringify(o))}catch{console.warn("storage is not available, recent emojis will not be saved")}}}class Be extends De{constructor(){super(localStorage)}}const Vt={dataStore:se,theme:Ie,animate:!0,showCategoryTabs:!0,showPreview:!0,showRecents:!0,showSearch:!0,showVariants:!0,emojisPerRow:8,visibleRows:6,emojiVersion:"auto",i18n:ie,locale:"en",maxRecents:50,custom:[]};!Pe()&&typeof window<"u"&&(console.warn("[picmo] localStorage not available, falling back to simple in-memory storage"),Object.defineProperty(window,"localStorage",{value:ze()}));function Ne(i={}){return{...Vt,...i,renderer:i.renderer||new Ve,recentsProvider:i.recentsProvider||new Be}}class U{constructor(){b(this,E);b(this,M);b(this,C,new Map)}on(e,t,o){v(this,M,we).call(this,e,t,o)}once(e,t,o){v(this,M,we).call(this,e,t,o,!0)}off(e,t){const o=v(this,E,Z).call(this,e);w(this,C).set(e,o.filter(s=>s.handler!==t))}emit(e,...t){v(this,E,Z).call(this,e).forEach(s=>{s.handler.apply(s.context,t),s.once&&this.off(e,s.handler)})}removeAll(){w(this,C).clear()}}C=new WeakMap,E=new WeakSet,Z=function(e){return w(this,C).has(e)||w(this,C).set(e,[]),w(this,C).get(e)},M=new WeakSet,we=function(e,t,o,s=!1){v(this,E,Z).call(this,e).push({context:o,handler:t,once:s})};const Oe={injectStyles:!0};class Dt extends U{}class Bt extends U{}const ne=y("emojiCategory","categoryName","noRecents","recentEmojis");class ce extends l{constructor({template:e,category:t,showVariants:o,lazyLoader:s}){super({template:e,classes:ne}),this.baseUIElements={categoryName:l.byClass(ne.categoryName)},this.category=t,this.showVariants=o,this.lazyLoader=s}setActive(e,t,o){this.emojiContainer.setActive(e,t,o)}}const Nt=new p(({classes:i,emoji:e})=>`
  <button
    type="button"
    class="${i.emojiButton}"
    title="${e.label}"
...
`);class hi extends l{constructor(){super({template:li,classes:L})}initialize(){this.uiElements={emoji:l.byClass(L.previewEmoji),name:l.byClass(L.previewName),tagList:l.byClass(L.tagList)},this.appEvents={"preview:show":this.showPreview,"preview:hide":this.hidePreview},super.initialize()}showPreview(e,t){if(j(this.ui.emoji,t),this.ui.name.textContent=e.label,e.tags){this.ui.tagList.style.display="flex";const o=e.tags.map(s=>ci.renderSync({tag:s,classes:L}));j(this.ui.tagList,...o)}}hidePreview(){P(this.ui.emoji),P(this.ui.name),P(this.ui.tagList)}}const di=new p(({classes:i,i18n:e})=>`
  <button title="${e.get("search.clear")}" class="${i.clearSearchButton}">
    <i data-icon="xmark"></i>
  </button>
`),mi=new p(({classes:i,i18n:e})=>`
<div class="${i.searchContainer}">
  <input class="${i.searchField}" placeholder="${e.get("search")}">
  <span class="${i.searchAccessory}"></span>
</div>
`,{mode:"async"}),$=y("searchContainer","searchField","clearButton","searchAccessory","clearSearchButton","notFound");class ui extends l{constructor({categories:e,emojiVersion:t}){super({template:mi,classes:$}),this.categories=e.filter(o=>o.key!=="recents"),this.emojiVersion=t,this.search=ke(this.search.bind(this),100)}initialize(){this.uiElements={searchField:l.byClass($.searchField),searchAccessory:l.byClass($.searchAccessory)},this.uiEvents=[l.childEvent("searchField","keydown",this.onKeyDown),l.childEvent("searchField","input",this.onSearchInput)],super.initialize()}async render(){return await super.render(),this.searchIcon=Re("search"),this.notFoundMessage=this.viewFactory.create(le,{message:this.i18n.get("search.notFound"),className:$.notFound,icon:"sad"}),this.notFoundMessage.renderSync(),this.errorMessage=this.viewFactory.create(le,{message:this.i18n.get("search.error")}),this.errorMessage.renderSync(),this.clearSearchButton=di.render({classes:$,i18n:this.i18n}),this.clearSearchButton.addEventListener("click",e=>this.onClearSearch(e)),this.searchField=this.ui.searchField,this.showSearchIcon(),this.el}showSearchIcon(){this.showSearchAccessory(this.searchIcon)}showClearSearchButton(){this.showSearchAccessory(this.clearSearchButton)}showSearchAccessory(e){j(this.ui.searchAccessory,e)}clear(){this.searchField.value="",this.showSearchIcon()}focus(){this.searchField.focus()}onClearSearch(e){var t;e.stopPropagation(),this.searchField.value="",(t=this.resultsContainer)==null||t.destroy(),this.resultsContainer=null,this.showSearchIcon(),this.events.emit("content:show"),this.searchField.focus()}handleResultsKeydown(e){this.resultsContainer&&e.key==="Escape"&&this.onClearSearch(e)}onKeyDown(e){var t;e.key==="Escape"&&this.searchField.value?this.onClearSearch(e):(e.key==="Enter"||e.key==="ArrowDown")&&this.resultsContainer&&(e.preventDefault(),(t=this.resultsContainer.el.querySelector('[tabindex="0"]'))==null||t.focus())}onSearchInput(e){this.searchField.value?(this.showClearSearchButton(),this.search()):this.onClearSearch(e)}async search(){var e;if(this.searchField.value)try{const t=await this.emojiData.searchEmojis(this.searchField.value,this.customEmojis,this.emojiVersion,this.categories);if(this.events.emit("preview:hide"),t.length){const o=new Ke;this.resultsContainer=this.viewFactory.create(F,{emojis:t,fullHeight:!0,showVariants:!0,lazyLoader:o}),this.resultsContainer.renderSync(),(e=this.resultsContainer)!=null&&e.el&&(o.observe(this.resultsContainer.el),this.resultsContainer.setActive(!0,{row:0,offset:0},!1),this.resultsContainer.el.addEventListener("keydown",s=>this.handleResultsKeydown(s)),this.events.emit("content:show",this.resultsContainer))}else this.events.emit("content:show",this.notFoundMessage)}catch{this.events.emit("content:show",this.errorMessage)}}}const pi=new p(({classes:i})=>`
  <div class="${i.variantOverlay}">
    <div class="${i.variantPopup}">
      <div data-view="emojis" data-render="sync"></div>
    </div>
  </div>
`),We=y("variantOverlay","variantPopup"),he={easing:"ease-in-out",duration:250,fill:"both"},Ge={opacity:[0,1]},Je={opacity:[0,1],transform:["scale3d(0.8, 0.8, 0.8)","scale3d(1, 1, 1)"]};class gi extends l{constructor({emoji:e,parent:t}){super({template:pi,classes:We,parent:t}),this.focusedEmojiIndex=0,this.focusTrap=new Ae,this.animateShow=()=>Promise.all([x(this.el,Ge,he,this.options),x(this.ui.popup,Je,he,this.options)]),this.emoji=e}initialize(){this.uiElements={popup:l.byClass(We.variantPopup)},this.uiEvents=[l.uiEvent("click",this.handleClick),l.uiEvent("keydown",this.handleKeydown)],super.initialize()}animateHide(){const e={...he,direction:"reverse"};return Promise.all([x(this.el,Ge,e,this.options),x(this.ui.popup,Je,e,this.options)])}async hide(){await this.animateHide(),this.events.emit("variantPopup:hide")}handleKeydown(e){e.key==="Escape"&&(this.hide(),e.stopPropagation())}handleClick(e){this.ui.popup.contains(e.target)||this.hide()}getEmoji(e){return this.renderedEmojis[e]}setFocusedEmoji(e){const t=this.getEmoji(this.focusedEmojiIndex);t.tabIndex=-1,this.focusedEmojiIndex=e;const o=this.getEmoji(this.focusedEmojiIndex);o.tabIndex=0,o.focus()}destroy(){this.emojiContainer.destroy(),this.focusTrap.deactivate(),super.destroy()}renderSync(){const e={...this.emoji,skins:null},t=(this.emoji.skins||[]).map(s=>({...s,label:this.emoji.label,tags:this.emoji.tags})),o=[e,...t];return this.emojiContainer=this.viewFactory.create(F,{emojis:o,preview:!1}),super.renderSync({emojis:this.emojiContainer}),o.length<this.options.emojisPerRow&&this.el.style.setProperty("--emojis-per-row",o.length.toString()),this.el}activate(){this.emojiContainer.setActive(!0,{row:0,offset:0},!0),this.focusTrap.activate(this.el)}}const yi=new p(({classes:i,i18n:e,category:t,pickerId:o,icon:s})=>`
...
`),de=y("categoryTab","categoryTabActive","categoryButton");class fi extends l{constructor({category:e,icon:t}){super({template:yi,classes:de}),this.isActive=!1,this.category=e,this.icon=t}initialize(){this.uiElements={button:l.byClass(de.categoryButton)},this.uiEvents=[l.childEvent("button","click",this.selectCategory),l.childEvent("button","focus",this.selectCategory)],super.initialize()}renderSync(){return super.renderSync({category:this.category,icon:this.icon}),this.ui.button.ariaSelected="false",this.el}setActive(e,t={}){const{changeFocusable:o,performFocus:s,scroll:r}={changeFocusable:!0,performFocus:!0,scroll:!0,...t};this.el.classList.toggle(de.categoryTabActive,e),o&&(this.ui.button.tabIndex=e?0:-1,this.ui.button.ariaSelected=e.toString()),e&&s&&(this.ui.button.focus(),r&&this.events.emit("category:select",this.category.key,{scroll:"animate",focus:"button",performFocus:!1})),this.isActive=e}selectCategory(){this.isActive||this.events.emit("category:select",this.category.key,{scroll:"animate",focus:"button",performFocus:!0})}}const vi=new p(({classes:i})=>`
  <div class="${i.categoryButtonsContainer}">
    <ul role="tablist" class="${i.categoryButtons}">
      <div data-placeholder="tabs"></div>
    </ul>
  </div>
`),wi=y("categoryButtons","categoryButtonsContainer");class bi extends l{constructor({categories:e}){super({template:vi,classes:wi}),this.activeCategoryIndex=0,this.categories=e}initialize(){this.keyBindings={ArrowLeft:this.stepSelectedTab(-1),ArrowRight:this.stepSelectedTab(1)},this.uiEvents=[l.uiEvent("scroll",this.checkOverflow)],super.initialize()}checkOverflow(){const e=Math.abs(this.el.scrollLeft-(this.el.scrollWidth-this.el.offsetWidth))>1,t=this.el.scrollLeft>0;this.el.className="categoryButtonsContainer",t&&e?this.el.classList.add("has-overflow-both"):t?this.el.classList.add("has-overflow-left"):e&&this.el.classList.add("has-overflow-right")}renderSync(){return this.tabViews=this.categories.map(e=>this.viewFactory.create(fi,{category:e,icon:K[e.key]})),super.renderSync({tabs:this.tabViews.map(e=>e.renderSync())}),this.el}get currentCategory(){return this.categories[this.activeCategoryIndex]}get currentTabView(){return this.tabViews[this.activeCategoryIndex]}setActiveTab(e,t={}){this.checkOverflow();const o=this.currentTabView,s=this.tabViews[e];o.setActive(!1,t),s.setActive(!0,t),this.activeCategoryIndex=e}getTargetCategory(e){return e<0?this.categories.length-1:e>=this.categories.length?0:e}stepSelectedTab(e){return()=>{const t=this.activeCategoryIndex+e;this.setActiveTab(this.getTargetCategory(t),{changeFocusable:!0,performFocus:!0})}}}function Oi(i){}const Ci=[{version:15,emoji:String.fromCodePoint(129768)},{version:14,emoji:String.fromCodePoint(128733)},{version:13,emoji:String.fromCodePoint(129729)},{version:12,emoji:String.fromCodePoint(129449)},{version:11,emoji:String.fromCodePoint(129463)},{version:5,emoji:String.fromCodePoint(129322)},{version:4,emoji:String.fromCodePoint(9877)},{version:3,emoji:String.fromCodePoint(129314)},{version:2,emoji:String.fromCodePoint(128488)},{version:1,emoji:String.fromCodePoint(128512)}];function ji(){const i=Ci.find(e=>_i(e.emoji));return(i==null?void 0:i.version)??1}function _i(i){const e=document.createElement("canvas").getContext("2d");if(e)return e.textBaseline="top",e.font="32px Arial",e.fillText(i,0,0),e.getImageData(16,16,1,1).data[0]!==0}function me(i,e){return Array.from({length:i},()=>e).join("")}function ki({showHeader:i,classes:e}){return i?`
  ...
  `}function Si(i){const{emojiCount:e,classes:t,theme:o,className:s,categoryCount:r}=i,a=({showSearch:g,classes:d})=>g?`
  ...
  `:"",c=({showCategoryTabs:g,classes:d})=>g?`
    <div class="${d.categoryTabsSkeleton}">
      ${me(r,`<div class="${d.placeholder} ${d.categoryTab}"></div>`)}
    </div>
  ...
  `:"",u=({showPreview:g,classes:d})=>g?`
    <div class="${d.previewSkeleton}">
      ...
      <ul class="${d.tagList}">
        ${me(3,`<li class="${d.placeholder} ${d.tag}"></li>`)}
      </ul>
    </div>
  `:"";return`
